<div x-data>
    {{--    <template x-on:dispatchexperienceformmodal.window="initModal($event.detail.title, $event.detail.form_id);"></template>--}}
    <div
        ...
        aria-modal="true"
{{--        x-show="showModal"--}}
        {{--        x-ref="experience_form_modal"--}}
    >
        <div
            class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0"
            {{--            @click.away="$wire.hideModal()"--}}
...
<script>
    ...
    function handleModal() {
        ...
        //     },
        //     fnOpenModal() {
        //         this.$refs.experience_form_modal.classList.remove('hidden');
        //         this.showModal = true;
        //     },
        //     submitDeleteForm() {
